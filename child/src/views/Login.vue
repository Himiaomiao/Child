      ...
      this.$refs[formName].validate((valid) => {
        ...
        if (valid) {
          ...
          if (this.ruleForm.value === '选项2') {
            this.adress =
              'http://moon-ice.com:38080/app/mock/16/guardian/login'
          } else if (this.ruleForm.value === '选项1') {
            // 教师
            this.adress = 'http://moon-ice.com:38080/app/mock/16/teacher/login'
          } else if (this.ruleForm.value === '选项3') {
            // 厨师
            this.adress = 'http://moon-ice.com:38080/app/mock/16/cook/login'
          } else if (this.ruleForm.value === '选项4') {
            // 食材管理员
            this.adress =
              'http://moon-ice.com:38080/app/mock/16/ingadmin/login'
          } else if (this.ruleForm.value === '选项5') {
            // 营养配餐员
            this.adress =
              'http://moon-ice.com:38080/app/mock/16/cateringstaff/login'
          }
